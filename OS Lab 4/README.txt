...
2. To test Compression Feature, Run the command:- 
      bash compressionTestScript.sh
3. To test Encryption Feature, Run the command:- 
      bash encryptionTestScript.sh
4. For removing all virtual disks and image files, Run the command:- 
      bash cleanScript.sh
