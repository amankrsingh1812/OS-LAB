...
2. To install ZFS(with appropriate params) and test Compression Feature, Run the command:- 
      bash compressionTestScript.sh
3. To install ZFS(with appropriate params) and test Encryption Feature, Run the command:- 
